...
class RAFTGMA(nn.Module):
    def __init__(self, hdim=128, cdim=128, corr_levels=4, corr_radius=4, num_heads=1, dropout=0.0):
        super().__init__()
        ...
        self.update_block = GMAUpdateBlock(hidden_dim=hdim, corr_levels=corr_levels, corr_radius=corr_radius, num_heads=num_heads)
        self.att = Attention(position_only=False, position_and_content=False, dim=cdim, heads=self.num_heads, max_pos_size=160, dim_head=cdim)
